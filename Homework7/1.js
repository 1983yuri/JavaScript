...
*/
const dropItemEls = document.querySelectorAll('.dropdown-item');
dropItemEls.forEach(element => {
...
"dropdown" следующую разметку:
  <a href="#">link</a>
*/
const dropDivEl = document.querySelector('div.dropdown');
dropDivEl.insertAdjacentHTML('afterbegin', '<a href="#">link</a>');
/*
5. У элемента с id "dropdownMenuButton" замените id на "superDropdown".
*/
const dropMenuButtEl = document.querySelector('#dropdownMenuButton');
dropMenuButtEl.id = 'superDropdown';
/*
...
*/
const ariaLabelEl = document.querySelector('[aria-labelledby="dropdownMenuButton"]');
ariaLabelEl.dataset.dd = '3';
/*
